...
public abstract class VersionedParcel {
    ...
    public VersionedParcel(SimpleArrayMap<String, Method> readCache, SimpleArrayMap<String, Method> writeCache, SimpleArrayMap<String, Class<?>> parcelizerCache) {
    ...
    private static final class Api21Impl {
        ...
        static void writeSize(VersionedParcel self, Size val) {
        ...
        static void writeSizeF(VersionedParcel self, SizeF val) {
            self.writeBoolean(val != null);
            if (val != null) {
        ...
        static Size readSize(VersionedParcel self) {
            if (self.readBoolean()) {
        ...
        static SizeF readSizeF(VersionedParcel self) {
            if (self.readBoolean()) {
