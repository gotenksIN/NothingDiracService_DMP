...
public final class ContentValues {
    public static final android.content.ContentValues contentValuesOf(Pair<String, ? extends Object>... pairs) {
        Intrinsics.checkNotNullParameter(pairs, "pairs");
        android.content.ContentValues $this$contentValuesOf_u24lambda_u240 = new android.content.ContentValues(pairs.length);
