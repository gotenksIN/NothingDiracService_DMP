...
public class IntentSanitizer {
    ...
    public static final class Builder {
        ...
        public Builder allowAction(String action) {
            ...
            allowAction(new IntentSanitizer$Builder$$ExternalSyntheticLambda11(action));
            return this;
        }
        ...
        public Builder allowType(String type) {
            ...
            return allowType(new IntentSanitizer$Builder$$ExternalSyntheticLambda11(type));
        }
        ...
        public Builder allowCategory(String category) {
            ...
            return allowCategory(new IntentSanitizer$Builder$$ExternalSyntheticLambda11(category));
        }
        ...
        public Builder allowPackage(String packageName) {
            ...
            return allowPackage(new IntentSanitizer$Builder$$ExternalSyntheticLambda11(packageName));
        }
        ...
        public Builder allowExtra(String key, Class<?> clazz) {
            return allowExtra(key, clazz, new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda1
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public <T> Builder allowExtra(String key, final Class<T> clazz, final Predicate<T> valueFilter) {
            ...
            return allowExtra(key, new Predicate() { // from class: androidx.core.content.IntentSanitizer$Builder$$ExternalSyntheticLambda14
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
