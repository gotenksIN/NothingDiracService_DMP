...
public final class SparseArrayCompatKt {
    ...
    public static final <E> void commonRemove(SparseArrayCompat<E> sparseArrayCompat, int key) {
        Intrinsics.checkNotNullParameter(sparseArrayCompat, "<this>");
        int i = ContainerHelpers.binarySearch(sparseArrayCompat.keys, sparseArrayCompat.size, key);
        if (i >= 0) {
            Object obj = sparseArrayCompat.values[i];
            Object obj2 = DELETED;
            if (obj != obj2) {
                sparseArrayCompat.values[i] = obj2;
    ...
    public static final <E> void commonPut(SparseArrayCompat<E> sparseArrayCompat, int key, E e) {
        ...
        if (sparseArrayCompat.garbage && sparseArrayCompat.size >= sparseArrayCompat.keys.length) {
            ...
            i2 = ~ContainerHelpers.binarySearch(sparseArrayCompat.keys, sparseArrayCompat.size, key);
        }
        if (sparseArrayCompat.size >= sparseArrayCompat.keys.length) {
            int n = ContainerHelpers.idealIntArraySize(sparseArrayCompat.size + 1);
    ...
    public static final <E> void commonPutAll(SparseArrayCompat<E> sparseArrayCompat, SparseArrayCompat<? extends E> other) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            int i$iv = ContainerHelpers.binarySearch(sparseArrayCompat.keys, sparseArrayCompat.size, key$iv);
            if (i$iv >= 0) {
                ...
                if (i$iv2 < sparseArrayCompat.size && sparseArrayCompat.values[i$iv2] == DELETED) {
                    ...
                    if (sparseArrayCompat.garbage && sparseArrayCompat.size >= sparseArrayCompat.keys.length) {
                        gc(sparseArrayCompat);
                        i$iv2 = ~ContainerHelpers.binarySearch(sparseArrayCompat.keys, sparseArrayCompat.size, key$iv);
                    }
                    if (sparseArrayCompat.size >= sparseArrayCompat.keys.length) {
                        int n$iv = ContainerHelpers.idealIntArraySize(sparseArrayCompat.size + 1);
        ...
        if (e2 == null) {
            ...
            if (binarySearch >= 0) {
                ...
                if (i2 < sparseArrayCompat.size && sparseArrayCompat.values[i2] == DELETED) {
                    ...
                    if (sparseArrayCompat.garbage && sparseArrayCompat.size >= sparseArrayCompat.keys.length) {
                        gc(sparseArrayCompat);
                        i2 = ~ContainerHelpers.binarySearch(sparseArrayCompat.keys, sparseArrayCompat.size, i);
                    }
                    if (sparseArrayCompat.size >= sparseArrayCompat.keys.length) {
                        int idealIntArraySize = ContainerHelpers.idealIntArraySize(sparseArrayCompat.size + 1);
    ...
    public static final <E> int commonIndexOfKey(SparseArrayCompat<E> sparseArrayCompat, int key) {
        ...
        return ContainerHelpers.binarySearch(sparseArrayCompat.keys, sparseArrayCompat.size, key);
    }
