    ...
    public void updateTextPositions(int position, float positionOffset, boolean force) {
        ...
        switch (vgrav2) {
            ...
            case 80:
                ...
                paddingTop = bottomGravTop + nextTopOffset;
                break;
            default:
                int prevTop3 = paddingTop2 + prevTopOffset;
                int currTop3 = paddingTop2 + currTopOffset;
                int nextTop2 = paddingTop2 + nextTopOffset;
                vgrav = prevTop3;
        ...
        int alignedCurrHeight2 = stripHeight + textView.getMeasuredHeight();
        textView.layout(currLeft, stripHeight, halfCurrWidth2, alignedCurrHeight2);
        ...
        int prevTop4 = paddingTop + textView3.getMeasuredHeight();
        textView3.layout(nextLeft, paddingTop, nextLeft + nextWidth, prevTop4);
