...
public class ViewPager extends ViewGroup {
    ...
    void initViewPager(Context context, AttributeSet attrs) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new OnApplyWindowInsetsListener() { // from class: androidx.viewpager.widget.ViewPager.4
            ...
            public WindowInsetsCompat onApplyWindowInsets(View v, WindowInsetsCompat originalInsets) {
                ...
                return new WindowInsetsCompat.Builder(applied).setSystemWindowInsets(Insets.of(res)).build();
            }
        });
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        View.MeasureSpec.makeMeasureSpec(childWidthSize, BasicMeasure.EXACTLY);
        int childHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(childHeightSize, BasicMeasure.EXACTLY);
        this.mInLayout = true;
        populate();
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            if (child2.getVisibility() != 8 && ((lp = (LayoutParams) child2.getLayoutParams()) == null || !lp.isDecor)) {
                ...
                child2.measure(widthSpec2, childHeightMeasureSpec);
            }
        }
    }
        ...
        switch (action) {
            case 0:
                ...
                if (this.mScrollState == 2 && Math.abs(this.mScroller.getFinalX() - this.mScroller.getCurrX()) > this.mCloseEnough) {
                    ...
                    if (EdgeEffectCompat.getDistance(this.mRightEdge) != f) {
                        EdgeEffectCompat.onPullDistance(this.mRightEdge, f, this.mLastMotionY / getHeight());
                        break;
                    }
                } else {
                    completeScroll(false);
            ...
            case 1:
                if (!this.mIsBeingDragged) {
                    ...
                    if (nextPage != currentPage || !needsInvalidate) {
                        ...
                        if (EdgeEffectCompat.getDistance(this.mLeftEdge) != 0.0f) {
                            this.mLeftEdge.onAbsorb(initialVelocity);
                            break;
                        }
                    } else {
                        this.mRightEdge.onAbsorb(-initialVelocity);
                        break;
                    }
                }
                break;
    ...
    private float releaseHorizontalGlow(float deltaX, float y) {
        ...
        if (EdgeEffectCompat.getDistance(this.mLeftEdge) != 0.0f) {
            consumed = -EdgeEffectCompat.onPullDistance(this.mLeftEdge, -pullDistance, 1.0f - displacement);
        } else if (EdgeEffectCompat.getDistance(this.mRightEdge) != 0.0f) {
            consumed = EdgeEffectCompat.onPullDistance(this.mRightEdge, pullDistance, displacement);
        }
    ...
    private boolean performDrag(float x, float y) {
        ...
        boolean needsInvalidate3 = releaseConsumed != 0.0f;
        if (Math.abs(deltaX) < 1.0E-4f) {
            return needsInvalidate3;
        }
        ...
        ItemInfo lastItem = this.mItems.get(r15.size() - 1);
        ...
        if (scrollX < leftBound) {
            if (leftAbsolute) {
                ...
                EdgeEffectCompat.onPullDistance(this.mLeftEdge, over / width, 1.0f - (y / getHeight()));
            ...
            if (!rightAbsolute) {
                ...
                EdgeEffectCompat.onPullDistance(this.mRightEdge, over2 / width, y / getHeight());
                needsInvalidate2 = true;
            }
            scrollX = rightBound;
        }
    ...
    private int determineTargetPage(int currentPage, float pageOffset, int velocity, int deltaX) {
        int targetPage;
        if (Math.abs(deltaX) > this.mFlingDistance && Math.abs(velocity) > this.mMinimumVelocity && EdgeEffectCompat.getDistance(this.mLeftEdge) == 0.0f && EdgeEffectCompat.getDistance(this.mRightEdge) == 0.0f) {
    ...
    public class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(ViewPager.ACCESSIBILITY_CLASS_NAME);
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setClassName(ViewPager.ACCESSIBILITY_CLASS_NAME);
