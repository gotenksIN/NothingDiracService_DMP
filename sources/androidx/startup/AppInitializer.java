...
public final class AppInitializer {
    ...
    public void discoverAndInitialize(Class<? extends InitializationProvider> initializationProvider) {
        try {
            try {
                Trace.beginSection(SECTION_NAME);
                ComponentName provider = new ComponentName(this.mContext, initializationProvider);
