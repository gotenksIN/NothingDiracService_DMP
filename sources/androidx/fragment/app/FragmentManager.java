...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    public /* synthetic */ void m61lambda$new$0$androidxfragmentappFragmentManager(Configuration newConfig) {
        if (isParentAdded()) {
    ...
    public /* synthetic */ void m62lambda$new$1$androidxfragmentappFragmentManager(Integer level) {
    ...
    public /* synthetic */ void m63lambda$new$2$androidxfragmentappFragmentManager(MultiWindowModeChangedInfo info) {
        if (isParentAdded()) {
    ...
    public /* synthetic */ void m64lambda$new$3$androidxfragmentappFragmentManager(PictureInPictureModeChangedInfo info) {
        if (isParentAdded()) {
    ...
    private void executeOpsTogether(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop, int startIndex, int endIndex) {
        ...
        ArrayList<OnBackStackChangedListener> arrayList2 = this.mBackStackChangeListeners;
    ...
    public Parcelable saveAllState() {
        ...
        Bundle savedState = m60lambda$attachController$4$androidxfragmentappFragmentManager();
