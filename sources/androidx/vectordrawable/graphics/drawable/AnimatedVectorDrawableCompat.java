...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    private AnimatedVectorDrawableCompat(Context context, AnimatedVectorDrawableCompatState state, Resources res) {
        ...
        if (state != null) {
            ...
            this.mAnimatedVectorState = new AnimatedVectorDrawableCompatState(context, null, callback, res);
        }
    }
    ...
    public static AnimatedVectorDrawableCompat create(Context context, int resId) {
        ...
        Drawable delegate = ResourcesCompat.getDrawable(context.getResources(), resId, context.getTheme());
        ObjectsCompat.requireNonNull(drawable, "Failed to load drawable");
        delegate.setCallback(drawable.mCallback);
        drawable.mCachedConstantStateDelegate = new AnimatedVectorDrawableDelegateState(delegate.getConstantState());
    ...
    private static class AnimatedVectorDrawableDelegateState extends Drawable.ConstantState {
        ...
        AnimatedVectorDrawableDelegateState(Drawable.ConstantState state) {
    ...
    public static class AnimatedVectorDrawableCompatState extends Drawable.ConstantState {
        ...
        AnimatedVectorDrawableCompatState(Context context, AnimatedVectorDrawableCompatState copy, Drawable.Callback owner, Resources res) {
            if (copy != null) {
    ...
    public static class Api23Impl {
        ...
        static boolean unregisterAnimationCallback(Object animatedVectorDrawable, Object callback) {
            return ((AnimatedVectorDrawable) animatedVectorDrawable).unregisterAnimationCallback((Animatable2.AnimationCallback) callback);
        }
        ...
        static void registerAnimationCallback(Object animatedVectorDrawable, Object callback) {
            ((AnimatedVectorDrawable) animatedVectorDrawable).registerAnimationCallback((Animatable2.AnimationCallback) callback);
        }
    }
}
