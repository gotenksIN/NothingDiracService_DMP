...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    static VectorDrawableCompat createWithoutDelegate(Resources res, int resId, Resources.Theme theme) {
        int type;
        try {
    ...
    private void printGroupTree(VGroup currentGroup, int level) {
        ...
        Log.v(LOGTAG, ((Object) indent) + "current group is :" + currentGroup.getGroupName() + " rotation is " + currentGroup.mRotate);
        Log.v(LOGTAG, ((Object) indent) + "matrix is :" + currentGroup.getLocalMatrix().toString());
    ...
    public static class VectorDrawableDelegateState extends Drawable.ConstantState {
        ...
        VectorDrawableDelegateState(Drawable.ConstantState state) {
    ...
    public static abstract class VPath extends VObject {
        ...
        public void printVPath(int level) {
            ...
            Log.v(VectorDrawableCompat.LOGTAG, ((Object) indent) + "current path is :" + this.mPathName + " pathData is " + nodesToString(this.mNodes));
        }
