    ...
    */
    public BottomAppBar(android.content.Context r13, android.util.AttributeSet r14, int r15) {
        /*
            ...
            android.content.res.ColorStateList r1 = com.google.android.material.resources.MaterialResources.getColorStateList(r13, r0, r1)
                ...
                public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
                    ...
                    if (Behavior.this.originalBottomMargin == 0) {
                        ...
                        if (child.fabAnchorMode == 1) {
                            bottomMargin = child.getResources().getDimensionPixelOffset(R.dimen.mtrl_bottomappbar_fab_bottom_margin);
                        }
