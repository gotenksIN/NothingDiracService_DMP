...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
        ...
        if (TextUtils.isEmpty(text) || listener == null) {
            ...
            tv.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.snackbar.Snackbar$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view) {
                    Snackbar.this.m832lambda$setAction$0$comgoogleandroidmaterialsnackbarSnackbar(listener, view);
                }
            });
        }
        return this;
    ...
    public /* synthetic */ void m832lambda$setAction$0$comgoogleandroidmaterialsnackbarSnackbar(View.OnClickListener listener, View view) {
