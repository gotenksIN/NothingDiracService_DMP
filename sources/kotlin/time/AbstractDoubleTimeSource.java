...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    public static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo2171elapsedNowUwyO8pc() {
            return Duration.m2217minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public ComparableTimeMark mo2174plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m2218plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo2173minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (Duration.m2187equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m2214isInfiniteimpl(this.offset)) {
                return Duration.INSTANCE.m2284getZEROUwyO8pc();
            }
            long offsetDiff = Duration.m2217minusLRDsOJo(this.offset, ((DoubleTimeMark) other).offset);
        ...
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m2187equalsimpl0(mo2173minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m2284getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m2210hashCodeimpl(Duration.m2218plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m2231toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m2284getZEROUwyO8pc(), null);
    }
}
