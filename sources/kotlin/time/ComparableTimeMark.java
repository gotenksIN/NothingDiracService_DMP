...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo2172minusLRDsOJo(long duration);

    /* renamed from: minus-UwyO8pc */
    long mo2173minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo2174plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m2177minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.mo2174plusLRDsOJo(Duration.m2234unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m2181compareToLRDsOJo($this.mo2173minusUwyO8pc(other), Duration.INSTANCE.m2284getZEROUwyO8pc());
        }
    }
}
