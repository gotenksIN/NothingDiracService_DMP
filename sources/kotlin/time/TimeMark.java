...
public interface TimeMark {
    ...
    TimeMark mo2172minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo2174plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m2319plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2318minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo2174plusLRDsOJo(Duration.m2234unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m2215isNegativeimpl($this.mo2171elapsedNowUwyO8pc());
        }
