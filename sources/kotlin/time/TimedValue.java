...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m2339copyRFiDyg4$default(TimedValue timedValue, Object obj, long j, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m2341copyRFiDyg4(obj, j);
    }
    ...
    public final TimedValue<T> m2341copyRFiDyg4(T value, long duration) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.value, timedValue.value) && Duration.m2187equalsimpl0(this.duration, timedValue.duration);
    }

    public int hashCode() {
        T t = this.value;
        return ((t == null ? 0 : t.hashCode()) * 31) + Duration.m2210hashCodeimpl(this.duration);
    }

    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m2231toStringimpl(this.duration)) + ')';
    }
    ...
    public final long m2342getDurationUwyO8pc() {
        return this.duration;
    }
