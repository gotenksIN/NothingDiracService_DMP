...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo2172minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m2318minusLRDsOJo(this, duration);
    }
    ...
    public long mo2171elapsedNowUwyO8pc() {
        return Duration.m2217minusLRDsOJo(this.mark.mo2171elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo2174plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m2218plusLRDsOJo(this.adjustment, duration), null);
    }
}
