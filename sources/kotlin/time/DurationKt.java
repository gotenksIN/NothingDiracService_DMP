...
public final class DurationKt {
    ...
    private static final long m2308timesmvk6XK0(int $this$times_u2dmvk6XK0, long duration) {
        return Duration.m2220timesUwyO8pc(duration, $this$times_u2dmvk6XK0);
    }

    /* renamed from: times-kIfJnKk */
    private static final long m2307timeskIfJnKk(double $this$times_u2dkIfJnKk, long duration) {
        return Duration.m2219timesUwyO8pc(duration, $this$times_u2dkIfJnKk);
    }
    ...
    */
    ...
    public static final long durationOfNanos(long normalNanos) {
        return Duration.m2182constructorimpl(normalNanos << 1);
    }

    public static final long durationOfMillis(long normalMillis) {
        return Duration.m2182constructorimpl((normalMillis << 1) + 1);
    }

    public static final long durationOf(long normalValue, int unitDiscriminator) {
        return Duration.m2182constructorimpl((normalValue << 1) + unitDiscriminator);
    }
