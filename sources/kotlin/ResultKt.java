...
public final class ResultKt {
    ...
    private static final <R> Object runCatching(Function0<? extends R> block) {
        ...
        try {
            ...
            return Result.m856constructorimpl(block.invoke());
        } catch (Throwable e) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m856constructorimpl(createFailure(e));
        }
    }
    ...
    private static final <T, R> Object runCatching(T t, Function1<? super T, ? extends R> block) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.m856constructorimpl(block.invoke(t));
        } catch (Throwable e) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m856constructorimpl(createFailure(e));
        }
    ...
    private static final <R, T> R fold(Object $this$fold, Function1<? super T, ? extends R> onSuccess, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        Intrinsics.checkNotNullParameter(onFailure, "onFailure");
        Throwable exception = Result.m859exceptionOrNullimpl($this$fold);
    ...
    private static final <R, T> Object map(Object $this$map, Function1<? super T, ? extends R> transform) {
        ...
        if (!Result.m863isSuccessimpl($this$map)) {
            return Result.m856constructorimpl($this$map);
        }
        Result.Companion companion = Result.INSTANCE;
        return Result.m856constructorimpl(transform.invoke($this$map));
    }

    private static final <R, T> Object mapCatching(Object $this$mapCatching, Function1<? super T, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        if (Result.m863isSuccessimpl($this$mapCatching)) {
            try {
                Result.Companion companion = Result.INSTANCE;
                Object $this$mapCatching_u24lambda_u243 = Result.m856constructorimpl(transform.invoke($this$mapCatching));
                return $this$mapCatching_u24lambda_u243;
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                return Result.m856constructorimpl(createFailure(th));
            }
        }
        return Result.m856constructorimpl($this$mapCatching);
    }

    private static final <R, T extends R> Object recover(Object $this$recover, Function1<? super Throwable, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        Throwable exception = Result.m859exceptionOrNullimpl($this$recover);
        if (exception == null) {
            return $this$recover;
        }
        Result.Companion companion = Result.INSTANCE;
        return Result.m856constructorimpl(transform.invoke(exception));
    }
    ...
    private static final <R, T extends R> Object recoverCatching(Object $this$recoverCatching, Function1<? super Throwable, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        Throwable exception = Result.m859exceptionOrNullimpl($this$recoverCatching);
        if (exception == null) {
            return $this$recoverCatching;
        }
        try {
            Result.Companion companion = Result.INSTANCE;
            Object $this$recoverCatching_u24lambda_u245 = Result.m856constructorimpl(transform.invoke(exception));
    ...
    private static final <T> Object onFailure(Object $this$onFailure, Function1<? super Throwable, Unit> action) {
        ...
        Throwable it = Result.m859exceptionOrNullimpl($this$onFailure);
        if (it != null) {
            action.invoke(it);
        }
    ...
    private static final <T> Object onSuccess(Object $this$onSuccess, Function1<? super T, Unit> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        if (Result.m863isSuccessimpl($this$onSuccess)) {
