...
public final class UStrings {
    ...
    public static final String m2168toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m2170toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m2169toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m2167toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (Integer.compareUnsigned(data, UInt.m951constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m868boximpl(UByte.m874constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m951constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
        return UShort.m1131boximpl(UShort.m1137constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m951constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m951constructorimpl(result * uradix);
            result = UInt.m951constructorimpl(UInt.m951constructorimpl(digit) + result2);
            if (Integer.compareUnsigned(result, result2) < 0) {
                return null;
            }
        }
        return UInt.m945boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m1030constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m1030constructorimpl(result * uradix);
            result = ULong.m1030constructorimpl(ULong.m1030constructorimpl(UInt.m951constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m1024boximpl(result);
    }
}
