...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step) {
        ...
        this.first = start;
        this.last = UProgressionUtil.m2076getProgressionLastElement7ftBX0g(start, endInclusive, step);
        this.step = step;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int m1030constructorimpl = ((int) ULong.m1030constructorimpl(j ^ ULong.m1030constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int m1030constructorimpl2 = (m1030constructorimpl + ((int) ULong.m1030constructorimpl(j2 ^ ULong.m1030constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return m1030constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) ULong.m1076toStringimpl(this.first)).append("..").append((Object) ULong.m1076toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            append = new StringBuilder().append((Object) ULong.m1076toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m1076toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m2102fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
