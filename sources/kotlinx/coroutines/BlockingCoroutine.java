            ...
            while (!Thread.interrupted()) {
                try {
                    ...
                    if (!isCompleted()) {
                        ...
                        T t = (T) JobSupportKt.unboxState(getState$external__kotlinx_coroutines__android_common__kotlinx_coroutines());
