...
public class DeferredCoroutine<T> extends AbstractCoroutine<T> implements Deferred<T>, SelectClause1<T> {
    ...
    static /* synthetic */ Object await$suspendImpl(DeferredCoroutine<T> deferredCoroutine, Continuation<? super T> continuation) {
        Object awaitInternal$external__kotlinx_coroutines__android_common__kotlinx_coroutines = deferredCoroutine.awaitInternal$external__kotlinx_coroutines__android_common__kotlinx_coroutines(continuation);
