...
final class WeakMapCtorCache extends CtorCache {
    ...
    public Function1<Throwable, Throwable> get(Class<? extends Throwable> key) {
        ...
        readLock.lock();
        try {
            Function1 it2 = exceptionCtors.get(key);
            if (it2 != null) {
            ...
            try {
                ...
                Function1 it3 = weakHashMap.get(key);
                if (it3 != null) {
