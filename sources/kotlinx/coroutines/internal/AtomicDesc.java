...
public abstract class AtomicDesc {
    ...
    public final void setAtomicOp(AtomicOp<?> atomicOp) {
        Intrinsics.checkNotNullParameter(atomicOp, "<set-?>");
