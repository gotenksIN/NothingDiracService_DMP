...
public class ScopeCoroutine<T> extends AbstractCoroutine<T> implements CoroutineStackFrame {
    ...
    public final Job getParent$external__kotlinx_coroutines__android_common__kotlinx_coroutines() {
        ...
        if (parentHandle$external__kotlinx_coroutines__android_common__kotlinx_coroutines != null) {
            return parentHandle$external__kotlinx_coroutines__android_common__kotlinx_coroutines.getParent();
        }
        return null;
    }
