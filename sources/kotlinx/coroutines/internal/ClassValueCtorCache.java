...
final class ClassValueCtorCache extends CtorCache {
    ...
    public Function1<Throwable, Throwable> get(Class<? extends Throwable> key) {
        ...
        Intrinsics.checkNotNullExpressionValue(function, "cache.get(key)");
