...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public void mo2404scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        ...
        this.$$delegate_0.mo2404scheduleResumeAfterDelay(timeMillis, continuation);
    }
        ...
        while (true) {
            ...
            if (task != null) {
                ...
                if (fairnessCounter >= 16 && this.dispatcher.isDispatchNeeded(this)) {
                    this.dispatcher.mo2403dispatch(this, this);
                    return;
                }
            } else {
