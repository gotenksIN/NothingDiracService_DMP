...
public final class LintKt {
    ...
    private static final <T> Flow<T> m2389catch(SharedFlow<? extends T> sharedFlow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> action) {
        Intrinsics.checkNotNullParameter(sharedFlow, "<this>");
        Intrinsics.checkNotNullParameter(action, "action");
        return FlowKt.m2381catch(sharedFlow, action);
    }
    ...
    static /* synthetic */ Flow retry$default(SharedFlow $this$retry_u24default, long retries, Function2 predicate, int i, Object obj) {
        ...
        Intrinsics.checkNotNullParameter($this$retry_u24default, "<this>");
    ...
    private static final <T> Flow<T> retry(SharedFlow<? extends T> sharedFlow, long retries, Function2<? super Throwable, ? super Continuation<? super Boolean>, ? extends Object> predicate) {
        Intrinsics.checkNotNullParameter(sharedFlow, "<this>");
        Intrinsics.checkNotNullParameter(predicate, "predicate");
        return FlowKt.retry(sharedFlow, retries, predicate);
    }

    @Deprecated(level = DeprecationLevel.WARNING, message = "SharedFlow never completes, so this operator has no effect.", replaceWith = @ReplaceWith(expression = "this", imports = {}))
    private static final <T> Flow<T> retryWhen(SharedFlow<? extends T> sharedFlow, Function4<? super FlowCollector<? super T>, ? super Throwable, ? super Long, ? super Continuation<? super Boolean>, ? extends Object> predicate) {
        Intrinsics.checkNotNullParameter(sharedFlow, "<this>");
        Intrinsics.checkNotNullParameter(predicate, "predicate");
        return FlowKt.retryWhen(sharedFlow, predicate);
    }
