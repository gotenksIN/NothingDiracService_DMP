...
public final class SharingConfig<T> {
    ...
    public SharingConfig(Flow<? extends T> upstream, int extraBufferCapacity, BufferOverflow onBufferOverflow, CoroutineContext context) {
