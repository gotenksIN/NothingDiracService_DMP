...
public final class ChannelAsFlow<T> extends ChannelFlow<T> {
    ...
    private final void markConsumed() {
        if (this.consume && !(!this.consumed.getAndSet(true))) {
