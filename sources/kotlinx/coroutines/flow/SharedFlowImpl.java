...
public class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    */
    public static /* synthetic */ java.lang.Object collect$suspendImpl(kotlinx.coroutines.flow.SharedFlowImpl<T> r7, kotlinx.coroutines.flow.FlowCollector<? super T> r8, kotlin.coroutines.Continuation<?> r9) {
        /*
    ...
    static /* synthetic */ Object emit$suspendImpl(SharedFlowImpl<T> sharedFlowImpl, T t, Continuation<? super Unit> continuation) {
        Object emitSuspend;
    ...
    public final Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        for (Continuation r : continuationArr) {
            if (r != null) {
                ...
                r.resumeWith(Result.m856constructorimpl(Unit.INSTANCE));
            }
        }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final kotlin.coroutines.Continuation<kotlin.Unit>[] updateCollectorIndexLocked$external__kotlinx_coroutines__android_common__kotlinx_coroutines(long r27) {
        /*
    ...
    private final Object tryTakeValue(SharedFlowSlot slot) {
        ...
        synchronized (this) {
            ...
            if (index < 0) {
                ...
                slot.index = 1 + index;
                continuationArr = updateCollectorIndexLocked$external__kotlinx_coroutines__android_common__kotlinx_coroutines(oldIndex);
                obj = newValue;
            }
        }
        Object value = obj;
        for (Continuation resume : continuationArr) {
            if (resume != null) {
                Result.Companion companion = Result.INSTANCE;
                resume.resumeWith(Result.m856constructorimpl(Unit.INSTANCE));
            }
        }
        return value;
    }
    ...
    public static final class Emitter implements DisposableHandle {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        public Emitter(SharedFlowImpl<?> flow, long index, Object value, Continuation<? super Unit> cont) {
