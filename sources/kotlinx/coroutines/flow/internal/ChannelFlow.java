...
public abstract class ChannelFlow<T> implements FusibleFlow<T> {
    ...
    public final Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> getCollectToFun$external__kotlinx_coroutines__android_common__kotlinx_coroutines() {
        return new ChannelFlow$collectToFun$1(this, null);
    }

    public final int getProduceCapacity$external__kotlinx_coroutines__android_common__kotlinx_coroutines() {
        int i = this.capacity;
        if (i == -3) {
            return -2;
        }
    ...
    public ReceiveChannel<T> produceImpl(CoroutineScope scope) {
        ...
        return ProduceKt.produce$default(scope, this.context, getProduceCapacity$external__kotlinx_coroutines__android_common__kotlinx_coroutines(), this.onBufferOverflow, CoroutineStart.ATOMIC, null, getCollectToFun$external__kotlinx_coroutines__android_common__kotlinx_coroutines(), 16, null);
    }
