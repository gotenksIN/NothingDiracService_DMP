...
public abstract class ChannelFlowOperator<S, T> extends ChannelFlow<T> {
    ...
    static /* synthetic */ Object collectTo$suspendImpl(ChannelFlowOperator<S, T> channelFlowOperator, ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) {
    ...
    static /* synthetic */ Object collect$suspendImpl(ChannelFlowOperator<S, T> channelFlowOperator, FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
