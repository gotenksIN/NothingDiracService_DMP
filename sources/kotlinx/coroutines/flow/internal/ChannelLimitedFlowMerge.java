...
public final class ChannelLimitedFlowMerge<T> extends ChannelFlow<T> {
    ...
    public ReceiveChannel<T> produceImpl(CoroutineScope scope) {
        ...
        return ProduceKt.produce(scope, this.context, this.capacity, getCollectToFun$external__kotlinx_coroutines__android_common__kotlinx_coroutines());
    }
