...
public final class ReadonlySharedFlow<T> implements SharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    public ReadonlySharedFlow(SharedFlow<? extends T> flow, Job job) {
