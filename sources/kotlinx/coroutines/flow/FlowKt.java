...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m2381catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt__ErrorsKt.m2388catch(flow, function3);
    }
    ...
    public static final <T> Flow<T> m2382debounceHG0u8IE(Flow<? extends T> flow, long timeout) {
        return FlowKt__DelayKt.m2384debounceHG0u8IE(flow, timeout);
    }
    ...
    public static final <T> Flow<T> m2383sampleHG0u8IE(Flow<? extends T> flow, long period) {
        return FlowKt__DelayKt.m2385sampleHG0u8IE(flow, period);
    }
