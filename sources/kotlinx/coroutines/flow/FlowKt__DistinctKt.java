...
public final /* synthetic */ class FlowKt__DistinctKt {
    ...
    public static final <T> Flow<T> distinctUntilChanged(Flow<? extends T> flow, Function2<? super T, ? super T, Boolean> areEquivalent) {
        Intrinsics.checkNotNullParameter(flow, "<this>");
        Intrinsics.checkNotNullParameter(areEquivalent, "areEquivalent");
        return distinctUntilChangedBy$FlowKt__DistinctKt(flow, defaultKeySelector, (Function2) TypeIntrinsics.beforeCheckcastToFunctionOfArity(areEquivalent, 2));
    }

    public static final <T, K> Flow<T> distinctUntilChangedBy(Flow<? extends T> flow, Function1<? super T, ? extends K> keySelector) {
        Intrinsics.checkNotNullParameter(flow, "<this>");
        Intrinsics.checkNotNullParameter(keySelector, "keySelector");
        return distinctUntilChangedBy$FlowKt__DistinctKt(flow, keySelector, defaultAreEquivalent);
    }
