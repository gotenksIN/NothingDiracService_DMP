...
public final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> debounce(Flow<? extends T> flow, Function1<? super T, Long> timeoutMillis) {
        Intrinsics.checkNotNullParameter(flow, "<this>");
    ...
    public static final <T> Flow<T> m2384debounceHG0u8IE(Flow<? extends T> debounce, long timeout) {
        Intrinsics.checkNotNullParameter(debounce, "$this$debounce");
        return FlowKt.debounce(debounce, DelayKt.m2347toDelayMillisLRDsOJo(timeout));
    }

    public static final <T> Flow<T> debounceDuration(Flow<? extends T> flow, final Function1<? super T, Duration> timeout) {
        Intrinsics.checkNotNullParameter(flow, "<this>");
        ...
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt$debounce$3
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Long invoke(T t) {
                return Long.valueOf(DelayKt.m2347toDelayMillisLRDsOJo(timeout.invoke(t).getRawValue()));
            }
        });
    }
    ...
    public static final ReceiveChannel<Unit> fixedPeriodTicker(CoroutineScope $this$fixedPeriodTicker, long delayMillis, long initialDelayMillis) {
        Intrinsics.checkNotNullParameter($this$fixedPeriodTicker, "<this>");
        if (!(delayMillis >= 0)) {
    ...
    public static final <T> Flow<T> m2385sampleHG0u8IE(Flow<? extends T> sample, long period) {
        Intrinsics.checkNotNullParameter(sample, "$this$sample");
        return FlowKt.sample(sample, DelayKt.m2347toDelayMillisLRDsOJo(period));
    }
}
