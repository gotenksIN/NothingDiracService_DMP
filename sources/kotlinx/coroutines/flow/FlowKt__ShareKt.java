...
public final /* synthetic */ class FlowKt__ShareKt {
    ...
    private static final <T> SharingConfig<T> configureSharing$FlowKt__ShareKt(Flow<? extends T> flow, int replay) {
        ...
        int defaultExtraCapacity = RangesKt.coerceAtLeast(replay, Channel.INSTANCE.getCHANNEL_DEFAULT_CAPACITY$external__kotlinx_coroutines__android_common__kotlinx_coroutines()) - replay;
    ...
    public static final <T> SharedFlow<T> onSubscription(SharedFlow<? extends T> sharedFlow, Function2<? super FlowCollector<? super T>, ? super Continuation<? super Unit>, ? extends Object> action) {
        Intrinsics.checkNotNullParameter(sharedFlow, "<this>");
        Intrinsics.checkNotNullParameter(action, "action");
        return new SubscribedSharedFlow(sharedFlow, action);
    }
}
