...
public interface CopyableThreadContextElement<S> extends ThreadContextElement<S> {
    ...
    public static final class DefaultImpls {
        public static <S, R> R fold(CopyableThreadContextElement<S> copyableThreadContextElement, R r, Function2<? super R, ? super CoroutineContext.Element, ? extends R> operation) {
            Intrinsics.checkNotNullParameter(operation, "operation");
            return (R) ThreadContextElement.DefaultImpls.fold(copyableThreadContextElement, r, operation);
        }
