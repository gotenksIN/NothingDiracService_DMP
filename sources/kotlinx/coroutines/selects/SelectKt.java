...
public final class SelectKt {
    ...
    public static final <R> void m2415onTimeout8Mi8wO0(SelectBuilder<? super R> onTimeout, long timeout, Function1<? super Continuation<? super R>, ? extends Object> block) {
        Intrinsics.checkNotNullParameter(onTimeout, "$this$onTimeout");
        Intrinsics.checkNotNullParameter(block, "block");
        onTimeout.onTimeout(DelayKt.m2347toDelayMillisLRDsOJo(timeout), block);
    }
    ...
    private static final <R> Object select$$forInline(Function1<? super SelectBuilder<? super R>, Unit> function1, Continuation<? super R> continuation) {
        ...
        SelectInstance scope = new SelectInstance(uCont);
        try {
            function1.invoke(scope);
        } catch (Throwable e) {
            scope.handleBuilderException(e);
