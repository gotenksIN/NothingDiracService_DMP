...
public final class AbstractChannelKt {
    ...
    private static final <E> Object toResult(Object $this$toResult) {
        return $this$toResult instanceof Closed ? ChannelResult.INSTANCE.m2377closedJP2dKIU(((Closed) $this$toResult).closeCause) : ChannelResult.INSTANCE.m2379successJP2dKIU($this$toResult);
    }

    private static final <E> Object toResult(Closed<?> closed) {
        return ChannelResult.INSTANCE.m2377closedJP2dKIU(closed.closeCause);
    }
}
