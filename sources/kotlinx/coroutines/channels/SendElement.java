...
public class SendElement<E> extends Send {
    ...
    public SendElement(E e, CancellableContinuation<? super Unit> cont) {
    ...
    public void resumeSendClosed(Closed<?> closed) {
        ...
        cancellableContinuation.resumeWith(Result.m856constructorimpl(ResultKt.createFailure(closed.getSendException())));
    }
