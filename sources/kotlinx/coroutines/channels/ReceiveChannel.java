...
public interface ReceiveChannel<E> {
    ...
    Object mo2357receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo2358tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo2358tryReceivePtdJZtk = receiveChannel.mo2358tryReceivePtdJZtk();
            if (ChannelResult.m2374isSuccessimpl(mo2358tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2370getOrThrowimpl(mo2358tryReceivePtdJZtk);
            }
            Throwable m2368exceptionOrNullimpl = ChannelResult.m2368exceptionOrNullimpl(mo2358tryReceivePtdJZtk);
            if (m2368exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecovery.recoverStackTrace(m2368exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) {
            ...
            L38:
                ...
                r2 = 1
                r4.label = r2
                java.lang.Object r3 = r3.mo2357receiveCatchingJP2dKIU(r4)
                if (r3 != r1) goto L45
                return r1
            L45:
                java.lang.Object r3 = kotlinx.coroutines.channels.ChannelResult.m2369getOrNullimpl(r3)
                return r3
            */
