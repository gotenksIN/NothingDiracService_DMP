...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2357receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2357receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2358tryReceivePtdJZtk() {
        return this._channel.mo2358tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo2359trySendJP2dKIU(E element) {
        return this._channel.mo2359trySendJP2dKIU(element);
    }
    ...
    public ChannelCoroutine(CoroutineContext parentContext, Channel<E> _channel, boolean initParentJob, boolean active) {
