...
public final /* synthetic */ class ChannelsKt__Channels_commonKt {
    ...
    public static final <E, R> R consume(ReceiveChannel<? extends E> receiveChannel, Function1<? super ReceiveChannel<? extends E>, ? extends R> block) {
        Intrinsics.checkNotNullParameter(receiveChannel, "<this>");
        Intrinsics.checkNotNullParameter(block, "block");
        try {
            R invoke = block.invoke(receiveChannel);
            InlineMarker.finallyStart(1);
