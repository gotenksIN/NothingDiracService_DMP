...
public interface SendChannel<E> {
    ...
    Object mo2359trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object result = sendChannel.mo2359trySendJP2dKIU(e);
            if (ChannelResult.m2374isSuccessimpl(result)) {
                return true;
            }
            Throwable m2368exceptionOrNullimpl = ChannelResult.m2368exceptionOrNullimpl(result);
