...
public abstract class AbstractCoroutine<T> extends JobSupport implements Job, Continuation<T>, CoroutineScope {
    ...
    public final void resumeWith(Object result) {
        Object state = makeCompletingOnce$external__kotlinx_coroutines__android_common__kotlinx_coroutines(CompletionStateKt.toState$default(result, null, 1, null));
    ...
    @Override // kotlinx.coroutines.JobSupport
    public final void handleOnCompletionException$external__kotlinx_coroutines__android_common__kotlinx_coroutines(Throwable exception) {
