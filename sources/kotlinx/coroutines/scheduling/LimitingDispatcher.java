...
final class LimitingDispatcher extends ExecutorCoroutineDispatcher implements TaskContext, Executor {
    ...
    public LimitingDispatcher(ExperimentalCoroutineDispatcher dispatcher, int parallelism, String name, int taskMode) {
        ...
        this.inFlightTasks = AtomicFU.atomic(0);
    }
    ...
    */
    private final void dispatch(java.lang.Runnable r5, boolean r6) {
        ...
        L1:
            ...
            r2.dispatchWithContext$external__kotlinx_coroutines__android_common__kotlinx_coroutines(r0, r3, r6)
            return
        L15:
    ...
    public void afterTask() {
        ...
        if (next != null) {
            this.dispatcher.dispatchWithContext$external__kotlinx_coroutines__android_common__kotlinx_coroutines(next, this, true);
            return;
        }
