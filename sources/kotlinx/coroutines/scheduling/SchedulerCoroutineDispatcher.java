...
public class SchedulerCoroutineDispatcher extends ExecutorCoroutineDispatcher {
    ...
    public final void dispatchWithContext$external__kotlinx_coroutines__android_common__kotlinx_coroutines(Runnable block, TaskContext context, boolean tailDispatch) {
        Intrinsics.checkNotNullParameter(block, "block");
        Intrinsics.checkNotNullParameter(context, "context");
    ...
    public final synchronized void usePrivateScheduler$external__kotlinx_coroutines__android_common__kotlinx_coroutines() {
        this.coroutineScheduler.shutdown(1000L);
        this.coroutineScheduler = createScheduler();
    }

    public final synchronized void shutdown$external__kotlinx_coroutines__android_common__kotlinx_coroutines(long timeout) {
        this.coroutineScheduler.shutdown(timeout);
    }

    public final void restore$external__kotlinx_coroutines__android_common__kotlinx_coroutines() {
