...
public final class TasksKt {
    ...
    public static final boolean isBlocking(Task $this$isBlocking) {
        Intrinsics.checkNotNullParameter($this$isBlocking, "<this>");
